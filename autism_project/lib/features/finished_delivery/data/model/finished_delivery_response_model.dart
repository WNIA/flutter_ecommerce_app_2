...
class FinishedDeliveryResponseModel extends FinishedDeliveryEntity{
  ...
  factory FinishedDeliveryResponseModel.fromJson(Map<String, dynamic> json) => FinishedDeliveryResponseModel(
    status: json["status"],
    success: json["success"],
    data: List<FinishedDeliveryPaginationData>.from(json["data"].map((x) => FinishedDeliveryPaginationData.fromJson(x))),
...
class FinishedDeliveryPaginationData {
  ...
  factory FinishedDeliveryPaginationData.fromJson(Map<String, dynamic> json) => FinishedDeliveryPaginationData(
    name: json["Name"],
    email: json["Email"],
