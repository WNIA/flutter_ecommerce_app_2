...
class LoginAndProfileRepositoryImpl implements LoginAndProfileRepository {
  ...
  Future<Either<Failure, LoginAndProfileResponseEntity>> getLoginResponse(
    ...
    return await _getData(loginAndProfileRemoteDataSource.fetchLoginResponse(requestModel));
  }

  @override
  Future<Either<Failure, LoginAndProfileResponseEntity>> getProfileResponse() async {
